...
const iAbs = sp.indexOf("SOL'S SOUL DIRECTIVE");
const iPresetAI = sp.indexOf('【预设内容】');
const iCore = sp.indexOf('你是 Sol');
...
check('① ABSOLUTE_CORE 永远置顶', sp.startsWith("[SYSTEM ARCHITECTURE & SOL'S SOUL DIRECTIVE]") && iAbs > -1 && iAbs < 60);
